...
import "relatedness-hail-v01.wdl" as relatednessHail
import "relatedness-hail-subset-samples-v01.wdl" as relatednessHailSubsetSamples
...
workflow RelatednessCohortSet {
    input {
        ...
        Array[String] format_fields_to_keep = ["GT", "AD", "DP"]
    ...
    if (!defined(somalier_vcf_file_)) {
        ...
        call mergeVCFSamples.mergeVCFSamples as mergeVCFSamples {
            ...
            format_fields_to_keep=format_fields_to_keep,
            recalculate_af=true,
